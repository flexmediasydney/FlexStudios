import { getAdminClient, createEntities, handleCors, jsonResponse, errorResponse, isQuietHours, getUserFromReq, serveWithAudit } from '../_shared/supabase.ts';
...
serveWithAudit('checkAndArchiveProject', async (req) => {
