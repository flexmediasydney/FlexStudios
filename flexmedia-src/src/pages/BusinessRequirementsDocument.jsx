...
const MODULES = [
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    requirements: [
      ...
      { id: "A-006", type: "UX", priority: "Medium", title: "Role Visibility in UI", desc: "The sidebar footer displays the currently authenticated user's full name and role badge (colour-coded: red=Admin, blue=Staff). Users can always identify their own role without navigating to settings." },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    requirements: [
      ...
      { id: "PR-002", type: "BR", priority: "Critical", title: "Eight Lifecycle Stages", desc: "Projects move through eight ordered stages: To Be Scheduled → Scheduled → Onsite → Uploaded → Submitted → In Progress → Partially Delivered → Delivered. These stages are the single source of truth for project workflow position. (Simplified from eleven stages.)" },
      ...
      { id: "PR-013", type: "FR", priority: "Medium", title: "Staff Role Assignments", desc: "Projects use role-based staff assignments (project owner, onsite staff, image editor, video editor) for notification targeting." },
      ...
      { id: "PR-021", type: "FR", priority: "Medium", title: "Staff Role Assignments", desc: "Staff role assignments on projects are used for workflow management and notification targeting." },
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    requirements: [
      ...
      { id: "PP-014", type: "SEC", priority: "Medium", title: "Access Restricted to Admin/Staff", desc: "The Products & Packages settings module is accessible only to users with master_admin or employee roles." },
