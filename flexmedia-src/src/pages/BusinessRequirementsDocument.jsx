...
const MODULES = [
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    requirements: [
      ...
      { id: "A-006", type: "UX", priority: "Medium", title: "Role Visibility in UI", desc: "The sidebar footer displays the currently authenticated user's full name and role badge (colour-coded: red=Admin, blue=Employee). Users can always identify their own role without navigating to settings." },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    requirements: [
      ...
      { id: "PP-014", type: "SEC", priority: "Medium", title: "Access Restricted to Admin/Employee", desc: "The Products & Packages settings module is accessible only to users with master_admin or employee roles." },
