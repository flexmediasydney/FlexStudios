...
const MODULES = [
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    requirements: [
      ...
      { id: "P-008", type: "ARC", priority: "Critical", title: "Role-Based Access Control (RBAC)", desc: "Three user roles exist: master_admin (full system access), employee (operational access including settings), and contractor (restricted access, own projects only). All access checks are enforced both client-side (component rendering) and server-side (backend function guards)." },
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    requirements: [
      { id: "A-001", type: "FR", priority: "Critical", title: "User Roles Defined", desc: "master_admin: unrestricted access, can manage all users, settings, pricing, and data. employee: can access settings (Products, Pricing, Organisation) and all projects. contractor: access to assigned projects only; no settings, no pricing, no user management." },
      ...
      { id: "A-004", type: "BR", priority: "High", title: "Contractor Project Visibility", desc: "Contractors only see projects where they appear in the assigned_users array. They cannot see any projects not assigned to them, regardless of status or client." },
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    requirements: [
      ...
      { id: "PR-013", type: "FR", priority: "Medium", title: "Assigned Users Array", desc: "Projects carry an assigned_users array listing all user IDs associated with the project. This array is used for contractor visibility filtering and notification targeting." },
      ...
      { id: "PR-021", type: "FR", priority: "Medium", title: "Assigned Users Array", desc: "Projects carry assigned_users array for contractor visibility filtering and notification targeting. Contractors see projects only if listed in this array." },
