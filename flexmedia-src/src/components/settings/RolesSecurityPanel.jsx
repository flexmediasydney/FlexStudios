...
const PAGE_SECTIONS = [
  ...
  { label: "Settings", pages: ["Settings","SettingsOrganisation","SettingsAutomationRules","SettingsRevisionTemplates","SettingsIntegrations","EmailSyncSettings","SettingsEmailSyncHealth","SettingsOperationsHealth","SettingsTonomoIntegration","SettingsTonomoMappings","SettingsNotifications","SettingsClients","SettingsProjectRulebook","SettingsTonomoWebhooks","SettingsAI","BusinessRequirementsDocument","HierarchyVisualization","SettingsTeamsUsers"] },
