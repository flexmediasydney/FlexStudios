...
export default function EmailInboxMain() {
  ...
  // Undo/redo stack limit is now enforced inline at push-time via
  // pushUndo/pushRedo helpers (see below), avoiding the extra re-render
  // that the old useEffect-based trim caused.
