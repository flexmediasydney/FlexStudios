import { Building, Users, User, Edit, Trash2, MoreVertical, Mail, Phone, Plus, AlertTriangle, Pencil } from "lucide-react";
                      ...
                      >
                        ...
                        <div className="flex items-start justify-between gap-2 mb-2">
                          ...
                          <div className="flex items-center gap-1 flex-shrink-0">
                            {agent.is_at_risk && (
                              <AlertTriangle className="h-3.5 w-3.5 text-amber-500" title="At risk — no recent bookings" />
                            )}
                        ...
                        {/* Contact details — click-to-action */}
                        ...
                        {Array.isArray(agent.tags) && agent.tags.length > 0 && (
                          <div className="flex flex-wrap gap-1 mb-2">
                            ...
                            {agent.tags.length > 3 && (
                              <span className="text-[9px] text-muted-foreground">+{agent.tags.length - 3}</span>
                            )}
                          </div>
                        )}
